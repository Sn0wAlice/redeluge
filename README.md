> **Fork notice:** redeluge is a fork of [Deluge](https://github.com/deluge-torrent/deluge),
> based on `deluge-2.2.1.dev0-43` (upstream commit [`e58075416`](https://github.com/deluge-torrent/deluge/commit/e58075416dedd53636e89b1cd240f86f2e7c2ee0), branch `develop`).
